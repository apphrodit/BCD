...
Create table Solicitacoes(
	...
	constraint fk_sol_dep_1 Forei   gn Key(Cod_Depto) references Departamentos(Cod_Depto),
...
CALL solicita_um_item(1002, 2000, 100, 135, 5, 10.99);

DELIMITER //

CREATE PROCEDURE adiciona_item(
  IN n_sol NUMERIC(4),
  IN prod NUMERIC(4),
  IN qtd NUMERIC(4),
  IN total NUMERIC(12, 2)
...
CALL adiciona_item(1002, 145, 3, 25.99);
